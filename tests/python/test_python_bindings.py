...
def test_graph_operations():
    ...
    try:
        ...
        print(f"✓ Created input tensors")
        
        # Test ReLU operation
        relu_result = tt_lazy.relu(tensor1)
        print(f"✓ ReLU operation successful, producer node: {relu_result.producer_node()}")
        
        # Test matrix multiplication
        matmul_result = tt_lazy.matmul(tensor1, tensor2)
        print(f"✓ Matrix multiplication successful, producer node: {matmul_result.producer_node()}")
        ...
        print(f"✓ Reduce operation successful, producer node: {reduce_result.producer_node()}")
